...
# Query Tally for all Journal vouchers and print their numbers and dates
payload = f"""<ENVELOPE>
    <HEADER>
        <VERSION>1</VERSION>
        <TALLYREQUEST>Export</TALLYREQUEST>
        <TYPE>Collection</TYPE>
        <ID>DebugJournalDates</ID>
    </HEADER>
    <BODY>
        <DESC>
            <STATICVARIABLES>
            ...
            <TDL>
                <TDLMESSAGE>
                    <COLLECTION NAME="DebugJournalDates">
                        <TYPE>Voucher</TYPE>
...
try:
    ...
    print(f"Total journal vouchers: {len(vouchers)}")
    results = []
    for v in vouchers:
