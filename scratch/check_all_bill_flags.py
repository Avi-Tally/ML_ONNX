            ...
            <TDL>
                <TDLMESSAGE>
                    <COLLECTION NAME="DebugBills">
                        <TYPE>Bill</TYPE>
                        <FETCH>Name, Parent, IsAdvance, IsNewRef, IsAgstRef, IsOnAccount, OnAccount, IsTemp</FETCH>
                        ...
                        <COMPUTE>OnAccount: $OnAccount</COMPUTE>
                        <COMPUTE>IsTemp: $IsTemp</COMPUTE>
